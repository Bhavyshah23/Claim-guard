...
import com.claimguard.backend.security.CustomUserDetailsService;
import com.claimguard.backend.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    // Allows your React app (running on a different port, e.g. 3000) to call this API
    @Bean
